...
INSERT INTO `creature_template` (`entry`, `modelid1`, `modelid2`, `name`, `femaleName`, `subname`, `IconName`, `type`, `type_flags`, `VerifiedBuild`) VALUES ('11970', '1126', '75463', 'Scout through the Jasperlode Mine done.', ' ', '', '', '10', '1024', '23420');
DELETE FROM `creature_template_locale` WHERE entry = 119704;
INSERT INTO `creature_template_locale` (`entry`, `locale`, `Name`, `NameAlt`, `TitleAlt`) VALUES ('119703', 'ruRU', 'Разведка в Яшмовой шахте проведена.', NULL, NULL);
