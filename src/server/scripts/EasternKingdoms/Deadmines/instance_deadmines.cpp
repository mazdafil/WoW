...
public:
    ...
    struct instance_deadmines_InstanceMapScript : public InstanceScript
    {
        ...
        {
            m_CreatureList.push_back(creature->GetGUIDLow());
 ...
 // private instance functions
        ...
        void SummonFactionNpc()
        {
            ...
            GameObject* door = instance->GetGameObject(GetGuidData(DATA_FACTORY_DOOR));
            if (!door)
                return;
    ...
    private:
        ObjectGuid m_ListOfGUID[MAX_DATA_ENCOUNTER];
