...
public:
    ...
    struct boss_foo_reaper_5000AI : public BossAI
    {
        boss_foo_reaper_5000AI(Creature* creature) : BossAI(creature, BOSS_FOO_REAPER_5000) 
        { 
...
class npc_foereaper_targeting_bunny : public CreatureScript
{
    public:
        ...
        {
            npc_foereaper_targeting_bunnyAI(Creature *c) : ScriptedAI(c)
            {
