...
public:
    ...
    struct npc_canyon_ettin_43197_AI : public VehicleAI
    {
        ...
        ObjectGuid m_oslowGUID;
        ObjectGuid m_boulderGUID;
        ObjectGuid m_trentGUID;
        ObjectGuid m_dmitriGUID;
        ObjectGuid m_jessGUID;
        ObjectGuid m_danielGUID;
        ObjectGuid m_matthewGUID;
        ObjectGuid m_alexGUID;
        uint32 m_state;
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            if (type == WAYPOINT_MOTION_TYPE)
                ...
                case 3:
                    ...
                    case 1:
                        if (Player* player = GetPlayer())
                            if (Creature* oslow = ObjectAccessor::GetCreature(*me, m_oslowGUID))
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = m_events.ExecuteEvent())
            {
                ...
                case EVENT_CHECK_FOLLOWING:
                {
                    ...
                    if (CheckAllGuids())
                        if (Creature* boulder = ObjectAccessor::GetCreature(*me, m_boulderGUID))
                ...
                case EVENT_TALK_PART_00:
                {
                    ...
                    if (Creature* trent = ObjectAccessor::GetCreature(*me, m_trentGUID))
                        trent->HandleEmoteCommand(EMOTE_STATE_STAND);
                    if (Creature* dmitri = ObjectAccessor::GetCreature(*me, m_dmitriGUID))
                        dmitri->HandleEmoteCommand(EMOTE_STATE_STAND);
                    if (Creature* jess = ObjectAccessor::GetCreature(*me, m_jessGUID))
                        jess->HandleEmoteCommand(EMOTE_STATE_STAND);
                    if (Creature* daniel = ObjectAccessor::GetCreature(*me, m_danielGUID))
                        daniel->HandleEmoteCommand(EMOTE_STATE_STAND);
                    if (Creature* matthew = ObjectAccessor::GetCreature(*me, m_matthewGUID))
                        matthew->HandleEmoteCommand(EMOTE_STATE_STAND);
                    if (Creature* alex = ObjectAccessor::GetCreature(*me, m_alexGUID))
                        alex->HandleEmoteCommand(EMOTE_STATE_STAND);
                ...
                case EVENT_TALK_PART_03:
                {
                    if (Player* player = GetPlayer())
                    {
                        ...
                        if (Creature* oslow = ObjectAccessor::GetCreature(*me, m_oslowGUID))
                            oslow->HandleEmoteCommand(EMOTE_STATE_STAND);
                    }
        ...
        bool CheckAllGuids()
        {
            ...
            if (m_oslowGUID != ObjectGuid::Empty)
                if (m_boulderGUID != ObjectGuid::Empty)
                    if (m_trentGUID != ObjectGuid::Empty)
                        if (m_dmitriGUID != ObjectGuid::Empty)
                            if (m_jessGUID != ObjectGuid::Empty)
                                if (m_danielGUID != ObjectGuid::Empty)
                                    if (m_matthewGUID != ObjectGuid::Empty)
                                        if (m_alexGUID != ObjectGuid::Empty)
                                            return true;
...
public:
    ...
    struct npc_colonel_troteman_43221AI : public ScriptedAI
    {
        ...
        Creature* GetSolomon()
        {
            if (Creature* solomon = ObjectAccessor::GetCreature(*me, m_solomonGUID))
                return solomon;
...
public:
    ...
    struct npc_danforth_43275AI : public ScriptedAI
    {
        ...
        EventMap m_events;
        ObjectGuid   m_leftDummyGUID, m_rightDummyGUID;
    ...
    struct npc_john_j_keeshan_43457AI : public ScriptedAI
    {
        ...
        void DoWork()
        {
            ...
            case 1:
                ...
                if (Creature* vehicle = me->FindNearestCreature(NPC_KEESHANS_RIVERBOAT_43450, 25.0f))
                {
                    vehicle->SetSpeed(MOVE_WALK, 3.5f);
    ...
    struct npc_john_j_keeshan_43611AI : public ScriptedAI
    {
        ...
        void DoWork()
        {
            ...
            case 8: 
                ...
                {
                    tank->HandleEmoteCommand(EMOTE_ONESHOT_ATTACK_THROWN);
