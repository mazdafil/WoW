...
public:
    ...
    struct npc_gorgal_angerscar_34634AI : public ScriptedAI
    {
        ...
        EventMap m_events;
        ObjectGuid m_kolkarGUID;
        ObjectGuid m_kurakGUID;
            ...
            while (uint32 eventId = m_events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_CHECK_KOLKAR:
                    {
                        ...
                        if (!IsAlive(kolkar))
                        {
                            if (m_kolkarGUID != ObjectGuid::Empty)
                                m_killCount++;
                            if (m_killCount < 3)
                            {
...
public:
    ...
    struct npc_halga_bloodeye_34258AI : public ScriptedAI
    {
        ...
        void SetGUID(ObjectGuid guid, int32 id = 0)
        {
            ...
            {
                case 99999:
                    if (m_playerGUID == ObjectGuid::Empty)
                        m_playerGUID = guid;
                    break;
            }
        }
...
public:
    ...
    struct npc_lead_caravan_kodo_34430AI : public ScriptedAI
    {
        ...
        uint32 m_timer;
        bool m_IsArrived;
        ObjectGuid m_halgaGUID;
        ObjectGuid m_playerGUID;
        ObjectGuid m_gunnerGUID;
        ObjectGuid m_balgorGUID;
        ObjectGuid m_kodoPackGUID;
...
public:
    ...
    struct npc_head_caravan_kodo_34577AI : public ScriptedAI
    {
        ...
        bool m_IsArrived;
        ObjectGuid m_playerGUID;
        ObjectGuid m_roccoGUID;
        ObjectGuid m_balgorGUID;
        ObjectGuid m_kodo2GUID;
        ObjectGuid m_hotseatGUID;
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            case NPC_CROSSROADS_CARAVAN_KODO:
                ...
                summon->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_REMOVE_CLIENT_CONTROL || UNIT_FLAG_IMMUNE_TO_NPC);
            ...
            case NPC_BURNING_BLADE_MOUNT:
                ...
                {
                    raider->SetSpeed(MOVE_WALK, 3.0f);
                    summon->SetSpeed(MOVE_WALK, 3.0f);
