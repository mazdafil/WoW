...
public:
    ...
    struct npc_the_wolf_39364_AI : public VehicleAI
    {
        ...
        EventMap m_events;
        ObjectGuid   m_playerGUID;
        ObjectGuid   m_shinGUID;
        ObjectGuid   m_kodo1GUID, m_kodo2GUID;
        uint8    m_phase;
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            while (uint32 eventId = m_events.ExecuteEvent())
            {
                ...
                case EVENT_CHECK_POSITION:
                {
                    ...
                    {
                        if (Creature* shin = ObjectAccessor::GetCreature(*me, m_shinGUID))
                    ...
                    case PHASE_SEARCHING_FOR_KODO:
                    {
                        ...
                        if (Creature* kodo = ObjectAccessor::GetCreature(*me, m_kodo1GUID))
                ...
                {
                    if (m_kodo1GUID == ObjectGuid::Empty || m_kodo2GUID == ObjectGuid::Empty)
                    {
                ...
                {
                    if (Creature* kodo1 = ObjectAccessor::GetCreature(*me, m_kodo1GUID))
                ...
                {
                    Position pos;
                    if (Creature* kodo = ObjectAccessor::GetCreature(*me, m_kodo2GUID))
                    {
        ...
        {
            if (m_shinGUID != ObjectGuid::Empty)
                return;
